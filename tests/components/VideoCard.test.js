...
describe('VideoCard', () => {
  ...
  it('renders VideoCard with all content', () => {
    ...
    expect(screen.getByText('This is a test video description that explains the content of the video.')).toBeInTheDocument();
  ...
  it('renders with different video data', () => {
    ...
    expect(screen.getByText('Custom description with different content for testing purposes.')).toBeInTheDocument();
  ...
  it('has correct card styling and behavior', () => {
    ...
    const card = container.querySelector('.bg-white.rounded-2xl.overflow-hidden.shadow-sm.hover\\:shadow-md.transition-shadow.h-full');
  ...
  it('has correct layout structure', () => {
    ...
    expect(card).toHaveClass('bg-white', 'rounded-2xl', 'overflow-hidden', 'shadow-sm', 'hover:shadow-md', 'transition-shadow', 'h-full');
    ...
    const playOverlay = container.querySelector('.absolute.inset-0.flex.items-center.justify-center');
  ...
  it('has correct play button styling', () => {
    ...
    expect(playButton).toHaveClass(
      'w-12', 'h-12', 'bg-white/90', 'rounded-full', 'flex', 'items-center', 
      'justify-center', 'hover:bg-white', 'transition-colors', 'cursor-pointer', 
