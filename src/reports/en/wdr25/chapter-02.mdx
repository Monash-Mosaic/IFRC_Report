import { ChapterQuote, ContributorRole, ContributorSpotlight, ContributorSpotlightName, ContributorSpotlightPosition, ContributorSpotlightRole, Contributors, SideNote, SmallQuote, SmallQuoteAuthor, Spotlight } from '@/components/CustomComponents';
...
<ChapterQuote>“To be persuasive we must be believable; to be believable we must be credible; to be credible we must be truthful.”</ChapterQuote>
...
<SideNote>Confirmation Bias refers to the tendency to seek out, favour and
      recall information that supports our existing beliefs, while ignoring or dismissing
      contradictory evidence.</SideNote>
...
<ChapterQuote>“So then, the advantage we had … is that when we were finally able to go in to
      ...
      the ones who were actually facing the emergency.”</ChapterQuote>
