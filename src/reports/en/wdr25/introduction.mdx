...
- the information ecosystem, the erosion of trust and global/local narratives (<a href="chapter-01"><span className="text-purple-600">Chapter 1, on page 29</span></a>, <a href="chapter-02"><span className="text-purple-600">Chapter 2, on page 69</span></a> and <a href="chapter-03"><span className="text-purple-600">Chapter 3, on page 103</span></a>)
- the consequences of harmful information on humanitarian responses (<a href="chapter-04"><span className="text-purple-600">Chapter 4, on page 137</span></a>)
- regulation and rights (<a href="chapter-05"><span className="text-purple-600">Chapter 5, on page 167</span></a>)
- community-first approaches (<a href="chapter-06"><span className="text-purple-600">Chapter 6, on page 211</span></a>)
- challenges related to the Fundamental Principles of the International Red Cross and Red Crescent Movement (<a href="chapter-07"><span className="text-purple-600">Chapter 7, on page 257</span></a>)
- a forward-looking reflection on resilience in the humanitarian sector (<a href="chapter-01"><span className="text-purple-600">Chapter 1, section 1.7, on page 46</span></a>).
