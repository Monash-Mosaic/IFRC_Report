...
export const description =
  "The International Federation of Red Cross and Red Crescent Societies' Annual Report for 2026, detailing global disaster response and humanitarian efforts.";

export const author = 'IFRC Secretariat';

export const category = 'Annual Report';

export const releaseDate = new Date('2026-03-05');

export const reportFile = {
  url: '/reports/wdr2026.pdf',
  size: 19_389_263,
};
...
export const chapters = {
  synthesis: {
    ...
    thumbnail: '/wdr26/chapters/Synthesis.jpg',
  ...
  introduction: {
    ...
    thumbnail: '/wdr26/chapters/Intro.jpg',
  ...
  'chapter-01': {
    ...
    thumbnail: '/wdr26/chapters/Chapter1.png',
    thumbnailOverlay: 'red',
    released: true,
  },
  'chapter-02': {
    ...
    thumbnail: '/wdr26/chapters/Chapter2.png',
    released: true,
    audios: [
      {
        id: 'intro',
  ...
  'chapter-03': {
    ...
    tableOfContents: [],
    thumbnail: '/wdr26/chapters/Chapter3.png',
    thumbnailOverlay: 'blue',
    released: true,
  },
  'chapter-04': {
    ...
    tableOfContents: [],
    thumbnail: '/wdr26/chapters/Chapter4.png',
    thumbnailOverlay: 'red',
    released: true,
  },
  'chapter-05': {
    ...
    tableOfContents: [],
    thumbnail: '/wdr26/chapters/Chapter5.png',
    thumbnailOverlay: 'red',
    released: true,
  },
  'chapter-06': {
    ...
    tableOfContents: [],
    thumbnail: '/wdr26/chapters/Chapter6.png',
    thumbnailOverlay: 'red',
    released: true,
  },
  'chapter-07': {
    ...
    tableOfContents: [],
    thumbnail: '/wdr26/chapters/Chapter7.png',
    thumbnailOverlay: 'red',
    released: true,
  },
  'chapter-08': {
    ...
    thumbnail: '/wdr26/chapters/Chapter8.png',
    thumbnailOverlay: 'red',
    released: true,
  },
  glossary: {
