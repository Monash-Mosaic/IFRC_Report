...
export const acknowledgementContributors = {
  ...
  tertiary: [
    { src: '/contributors/wdr26-logotypes-09.svg', alt: '瑞典红十字会', order: 1 },
    { src: '/contributors/wdr26-logotypes-10.svg', alt: '德国红十字会', order: 2 },
    { src: '/contributors/wdr26-logotypes-11.svg', alt: '日本红十字会', order: 3 },
    { src: '/contributors/wdr26-logotypes-12.svg', alt: '芬兰红十字会', order: 4 },
    { src: '/contributors/wdr26-logotypes-13.svg', alt: '丹麦红十字会', order: 5 },
    { src: '/contributors/wdr26-logotypes-14.svg', alt: '瑞士红十字会', order: 6 },
    { src: '/contributors/wdr26-logotypes-15.svg', alt: '澳大利亚政府 – 外交贸易部', order: 7 },
  ],
};
