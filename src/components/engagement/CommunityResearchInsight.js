  ...
  return (
    <div className="p-5 mt-8 bg-white rounded-xl border border-slate-200 shadow-sm">
      ...
      <div className="mt-10 text-sm text-slate-700 italic leading-relaxed text-center">
        &ldquo;Misinformation often results into mistrust between the community and others especially
        ...
        community dissatisfaction and mistrust, which should be taken into consideration.&rdquo;
      </div>
    </div>
  );
}
