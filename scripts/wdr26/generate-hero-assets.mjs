 ...
 * 
 * Input:
 *   public/wdr26/wdr_hero_video.mp4
 * 
 * Output:
 *   public/wdr26/hero/poster.webp
 *   public/wdr26/hero/fallback-muted.mp4
 *   public/wdr26/hero/hls/240p.m3u8 + segments
 *   public/wdr26/hero/hls/360p.m3u8 + segments
 *   public/wdr26/hero/hls/480p.m3u8 + segments
 *   public/wdr26/hero/hls/720p.m3u8 + segments
 *   public/wdr26/hero/hls/1080p.m3u8 + segments
 *   public/wdr26/hero/hls/master.m3u8
 *   public/wdr26/hero/hls/2g.m3u8
 *   public/wdr26/hero/hls/3g.m3u8
 *   public/wdr26/hero/hls/low4g.m3u8
 *   public/wdr26/hero/hls/4g.m3u8
 *   public/wdr26/hero/hls/save_data.m3u8
 */
...
const SOURCE_VIDEO = join(projectRoot, 'public/wdr26/wdr_hero_video.mp4');
const OUTPUT_DIR = join(projectRoot, 'public/wdr26/hero');
...
async function main() {
  ...
  if (!existsSync(SOURCE_VIDEO)) {
    ...
    log('Please ensure the source MP4 file exists at: public/wdr26/wdr_hero_video.mp4', 'yellow');
    process.exit(1);
  }
