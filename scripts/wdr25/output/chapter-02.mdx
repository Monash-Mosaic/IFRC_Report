import {Caption, ChapterQuote, Introduction, Sidenote, SidenoteContext, SidenotesContributionsFirst, SmallQuoteGroup, SmallQuoteContent, SmallQuoteAuthor, ContributorGroup, H1Contributor, Contributor, ContributorRole, H1Ebn, Unhandledh1c1, Unhandledh2c1, Unhandledh1c2, Unhandledh2c2, Unhandledh3c2, H1Fig, ContributorName, ContributorPosition} from "@/components/CustomComponents";
...
<Caption>
  April 2015, pre-election tension and related violence erupted in Burundi, resulting in more than 600 people being injured, and a number of deaths in the capital of Bujumbura. More than 120,000 Burundians have fled to neighbouring countries. ©IFRC
</Caption>
...
<H1Ebn>
  Ability (Competence) – “I can rely on the Canadian Red Cross to operate competently and effectively.”
</H1Ebn>
...
<H1Ebn>
  Integrity (Character) – “I can rely on the Canadian Red Cross to do the right thing.”
</H1Ebn>
